...
function handler(parameter:string[]){
    switch(parameter[0]){
        ...
        case "registration_numbers_for_cars_with_colour":
            console.log(parking_lot.registration_numbers_for_cars_with_colour(parameter[1]));
            break;
        case "slot_numbers_for_cars_with_colour" :
            console.log(parking_lot.slot_numbers_for_cars_with_colour(parameter[1]));
            break;
        case "slot_number_for_registration_number":
            console.log(parking_lot.slot_number_for_registration_number(parameter[1]));
            break;
